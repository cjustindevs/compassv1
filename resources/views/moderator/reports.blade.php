...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        table.report-table tr:hover td { background: #F9FAFB; }
        ...
        .benchmark-box .value { font-size: 22px; font-weight: 800; color: #1F2937; }
        .benchmark-box .label { font-size: 11px; color: #9CA3AF; text-transform: uppercase; letter-spacing: 0.04em; margin-top: 2px; }
