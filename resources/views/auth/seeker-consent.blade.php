...
@section('content')
    ...
    <details class="mb-4 border rounded-lg p-4"><summary class="font-semibold cursor-pointer">Terms and Condition - {{ \App\Services\ConsentService::VERSION }}</summary><div class="space-y-3 mt-3 text-sm">@include('partials.terms-text')</div></details>
    <details class="mb-4 border rounded-lg p-4"><summary class="font-semibold cursor-pointer">Privacy Notice - {{ \App\Services\ConsentService::VERSION }}</summary><div class="space-y-3 mt-3 text-sm">@include('partials.privacy-text')</div></details>
