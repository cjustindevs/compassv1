    ...
    >
        <header class="roles-page-heading">
            <div>
                ...
                <p>Read-only summary of administrator capabilities. Server policies enforce access; this page does not change permissions.</p>
            </div>

            <div class="roles-page-actions" aria-label="Permission matrix actions">
                <button class="admin-button admin-button-secondary" type="button" disabled title="Role duplication is not implemented">
        ...
        <section class="permission-matrix-card" aria-labelledby="permission-matrix-title" data-permission-matrix>
            <header class="permission-matrix-context">
                ...
                <span class="permission-save-state" data-permission-save-state aria-live="polite">Enforced by server policies</span>
            </header>
